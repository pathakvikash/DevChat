...
const BASE =
  "inline-flex items-center justify-center gap-2 rounded-[var(--glass-radius-md)] px-4 py-2 text-sm font-medium transition disabled:opacity-50 disabled:cursor-not-allowed";
